...
| 95% CI lower bound for R squared est. | 95% CI upper bound for R squared est. | 95% CI lower bound for log(beta\_0 \* beta\_1) est. | 95% CI upper bound for log(beta\_0 \* beta\_1) est. |
|--------------------------------------:|--------------------------------------:|----------------------------------------------------:|----------------------------------------------------:|
